...
+I've tried many 3rd party themes, but keep coming back to the default light theme. Let's try Spacemacs theme and modeline, as long as it's possible to remove extra backgrounds from everywhere...+
