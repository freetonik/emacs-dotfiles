...
#+BEGIN_SRC emacs-lisp
(setq magit-repository-directories '(("\~/code" . 4) ("\~/Google Drive/Codexpanse/Course materials" . 3) ("\~/icloud/KnowledgeBase" . 3)))
...
(use-package markdown-mode
  ...
  :init (setq markdown-command "pandoc --no-highlight -smart"))
...
Store all my org files in iCloud (=/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase=).

#+BEGIN_SRC emacs-lisp
(setq org-directory "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org")
#+END_SRC

And all of those files should be in included agenda.

#+BEGIN_SRC emacs-lisp
(setq org-agenda-files '("/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org"))
#+END_SRC
...
(defun org-mode-export-links ()
  ...
  (when (equal (buffer-file-name) "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org/links.org")
    (progn
...
(global-set-key (kbd "\e\ej") (lambda () (interactive) (find-file "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org/journal.org")))
(global-set-key (kbd "\e\em") (lambda () (interactive) (find-file "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org/main.org")))
(global-set-key (kbd "\e\el") (lambda () (interactive) (find-file "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org/links.org")))
(global-set-key (kbd "\e\eb") (lambda () (interactive) (find-file "~/code/rakhim.org/content-org/blog.org")))
(global-set-key (kbd "\e\ef") (lambda () (interactive) (counsel-rg nil "/Users/rakhim/Library/Mobile Documents/com~apple~CloudDocs/KnowledgeBase/Etc/org")))
#+END_SRC
...
;;      \\input{/users/rakhim/.emacs.d/latex/tufte-book.cls}"
;;       ("\\part{%s}" . "\\part*{%s}")
;;       ("\\chapter{%s}" . "\\chapter*{%s}")
;;       ("\\section{%s}" . "\\section*{%s}")
;;       ("\\subsection{%s}" . "\\subsection*{%s}")))))
