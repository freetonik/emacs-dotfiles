...
(use-package simpleclip
  :commands simpleclip-mode simpleclip-copy
  :init
  (simpleclip-mode 1))
#+END_SRC
...
(use-package shackle
  :defer 1
  ;; use :commands to to introduce dummy variable and function declarations solely for the sake of the byte-compiler
...
(use-package markdown-mode
  :defer 1
  :commands (markdown-mode gfm-mode markdown-kill-ring-save)
...
#+BEGIN_SRC emacs-lisp :tangle no
(global-set-key (kbd "\e\ej") (lambda () (interactive) (find-file "PATH_TO/org/journal.org")))
#+END_SRC

** Search in all org files

#+BEGIN_SRC emacs-lisp :tangle no
(global-set-key (kbd "\e\ef") (lambda () (interactive) (counsel-rg nil "PATH_TO/org")))
#+END_SRC
